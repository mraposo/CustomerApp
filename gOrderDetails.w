...
ttOrderUpd.Ordernum ttOrderUpd.Creditcard ttOrderUpd.BillToID ~
...
ttOrderUpd.ShipDate ttOrderUpd.ShipToID ttOrderUpd.Terms ~
...
&Scoped-Define ENABLED-OBJECTS RECT-1 BtnExit 
&Scoped-Define DISPLAYED-FIELDS ttOrderUpd.CustNum ttOrderUpd.Ordernum ~
ttOrderUpd.Creditcard ttOrderUpd.BillToID ttOrderUpd.Instructions ~
ttOrderUpd.OrderDate ttOrderUpd.OrderStatus ttOrderUpd.Carrier ~
ttOrderUpd.PO ttOrderUpd.PromiseDate ttOrderUpd.SalesRep ~
ttOrderUpd.ShipDate ttOrderUpd.ShipToID ttOrderUpd.Terms ~
ttOrderUpd.WarehouseNum 
...
DEFINE FRAME Dialog-Frame
     ttOrderUpd.CustNum AT ROW 2.35 COL 18 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 7.43 BY 1
     BtnExit AT ROW 2.62 COL 66 WIDGET-ID 34
...
/* SETTINGS FOR FILL-IN ttOrderUpd.BillToID IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.Carrier IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR COMBO-BOX ttOrderUpd.Creditcard IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.CustNum IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.Instructions IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.OrderDate IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.Ordernum IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR COMBO-BOX ttOrderUpd.OrderStatus IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.PO IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.PromiseDate IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.SalesRep IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.ShipDate IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.ShipToID IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.Terms IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ttOrderUpd.WarehouseNum IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE ttOrderUpd THEN 
    DISPLAY ttOrderUpd.CustNum ttOrderUpd.Ordernum ttOrderUpd.Creditcard 
          ttOrderUpd.BillToID ttOrderUpd.Instructions ttOrderUpd.OrderDate 
          ttOrderUpd.OrderStatus ttOrderUpd.Carrier ttOrderUpd.PO 
          ttOrderUpd.PromiseDate ttOrderUpd.SalesRep ttOrderUpd.ShipDate 
          ttOrderUpd.ShipToID ttOrderUpd.Terms ttOrderUpd.WarehouseNum 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-1 BtnExit 
      WITH FRAME Dialog-Frame.
